...
/**
 * @brief Metodo que devuelve la inversa de la cadena
*/
...
/**
 * @brief Constructor de la clase Cadena que funciona con un vector de Simbolos
*/
...
/**
 * @brief Sobrecarga del operador << de la clase Cadena 
*/
...
/**
 * @brief Sobrecarga del operador < de la clase Cadena, lo utiliza set
*/
...
/**
 * @brief Metodo para extraer la cadena almacenada en el vector de Simbolos
*/
